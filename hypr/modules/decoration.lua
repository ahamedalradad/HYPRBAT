...
hl.curve("easeOutSine", { type = "bezier", points = { { 0.37, 0 }, { 0.63, 1 } } })
-- Default springs
hl.curve("easy", { type = "spring", mass = 0.8, stiffness = 75.2633, dampening = 15.8273644 })

hl.animation({ leaf = "global", enabled = true, speed = 10, bezier = "default" })
hl.animation({ leaf = "border", enabled = true, speed = 3.39, bezier = "quick" })
hl.animation({ leaf = "windows", enabled = true, speed = 4.36, spring = "easy" })
